...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Louaq', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'a coder', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://louaq.github.io', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Louaq, 博客', // 网站关键词 英文逗号隔开
